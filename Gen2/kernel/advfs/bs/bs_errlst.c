...
#include <sys/systm.h>
#include <sys/errno.h>
/*                           ----> Added below for libadvfs.  I couldn't 
 *                                 find ESUCESS defined anywhere in user space.
 */
#ifndef _KERNEL
#define ESUCCESS 0
#endif /* !_KERNEL */
...
char *bs_errlist[] = {
    ...
    "EBAD_DOMAIN_POINTER (-1034)",
    "E_RANGE_NOT_MAPPED (-1035)",
    "ENO_XTNTS (-1036)",
    "ENO_BS_ATTR (-1037)",
    "EBAD_TAG (-1038)",
    "EXTND_FAILURE (-1039)",
    ...
    "E_UNALLIGNED_ADDR (-1074)",
    "E_UNALLIGNED_BCOUNT (-1075)",
    ...
    "E_1081 (-1081)",
    "E_TAG_EXISTS (-1082)",
    "E_CANT_CREATE_BR_CAT (-1083)",
    "E_BR_CAT_DOMAIN_UNAVAILABLE (-1084)",
    "E_CANT_ACCESS_BR_CAT (-1085)",
    "E_DOMAIN_ALREADY_EXISTS (-1086)",
    "E_MAX_PINS_EXCEEDED (-1087)",
    "E_CANT_CREATE_BF_CAT (-1088)",
    "E_DOMAIN_NOT_REGISTERED (-1089)",
    "E_CANT_ACCESS_BF_CAT (-1090)",
    "W_DOMAIN_ALREADY_REGISTERED (-1091)",
    "E_CANT_ALLOC_CAT_REC (-1092)",
    "E_NO_SUCH_BF_SET (-1093)",
    "E_BAD_BF_SET_POINTER (-1094)",
    "E_TOO_MANY_BF_SETS (-1095)",
    "E_BAD_BF_SET_TBL (-1096)",
    "E_BF_SET_NOT_CLOSED (-1097)",
    "E_BUF_NOT_UNPIN_BLOCKED (-1098)",
    ...
    "E_READ_ONLY (-1114)",
    "E_TOO_MANY_SNAPSHOTS (-1115)",
    "E_OUT_OF_SYNC_SNAPSHOTS (-1116)",
    "E_HAS_SNAPSHOT (-1117)",
    ...
    "E_ILLEGAL_SNAPSHOT_OP (-1191)",
    "E_DISK_TOO_SMALL (-1192)"
};
 ...
 * operating system in which AdvFS is embedded, and the above list is
 * OS independent.
 *
...
int sts_to_errno_map[] = {
    ...
    EBADF,       /* EBAD_DOMAIN_POINTER */
    EIO,         /* E_RANGE_NOT_MAPPED */
    EIO,         /* ENO_XTNTS */
    EIO,         /* ENO_BS_ATTR */
    EBADF,       /* EBAD_TAG */
    EIO,         /* EXTND_FAILURE */
    ...
    EROFS,       /* E_READ_ONLY */
    EMFILE,      /* E_TOO_MANY_SNAPSHOTS */
    EIO,         /* E_OUT_OF_SYNC_SNAPSHOT */
    EIO,         /* E_HAS_SNAPSHOT */
    ...
    ESUCCESS,    /* E_CANT_SNAP_A_SNAPSHOT */
    ...
    EINVAL,      /* E_NO_SNAPSHOT_STG                   (-1183) */
    EINVAL,      /* E_BAD_RANGE                         (-1184) */
    ...
    EINVAL,      /* E_ILLEGAL_SNAPSHOT_OP               (-1191) */
};
    ...
    )
{
    ...
    if ((abs( sts ) < MSFS_FIRST_ERR)) {
        ...
        if ((sts > 0) && (sts <= sys_nerr)) {
            snprintf(msg, sizeof(msg), "%s (%d)", sys_errlist[sts], sts);
        } else {
            snprintf(msg, sizeof(msg), "unknown error (%d)", sts);
        }
        return msg;
#endif
