 ...
 */
/*
 * @(#)$RCSfile: thread_interfaces.h,v $ $Revision: 1.1.7.1 $ (DEC) $Date: 2000/10/18 14:35:17 $
 */
...
static char*
rcsid_thread_interfaces = "thread_interfaces.h - $Date: 2000/10/18 14:35:17 $";

#include <pthread.h>

#ifdef ULTRIX
typedef pthread_addr_t any_t;
typedef pthread_startroutine_t t_start_routine;
